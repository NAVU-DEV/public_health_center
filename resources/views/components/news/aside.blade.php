<aside class="col-lg-4 sidebar mt-8 mt-lg-6">
    ...
    <div class="widget">
        ...
        <ul class="image-list">
            ...
            <li>
                <figure class="rounded"><a href="./blog-post.html"><img src="{{ URL::asset('assets/img/news/' . $berita->thumbnail) }}" alt="" /></a></figure>
                <div class="post-content">
                    <h6 class="mb-2"> <a class="link-dark" href="./blog-post.html">{{ $berita->title }}</a> </h6>
                    <ul class="post-meta">
